...
import { 
  Package, Plus, Save, X, Globe, Smartphone, Monitor, 
  Palette, TrendingUp, Cloud, ArrowLeft 
} from "lucide-react";
          ...
          <div className="mb-12 text-center">
            <div style={{
              ...
              <div style={{
                ...
                <Plus size={40} strokeWidth={3} color="#111111" />
              </div>
            </div>
            <h1 style={{
              fontFamily: 'Poppins, sans-serif',
            ...
            <p style={{
              ...
              Create a new service to showcase on your services page
            </p>
          </div>
